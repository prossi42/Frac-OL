...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   key_hook_multi_two.c                               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: prossi <marvin@42.fr>                      +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/10/05 12:50:44 by prossi            #+#    #+#             */
/*   Updated: 2017/10/05 12:50:46 by prossi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../include/fractol.h"

void	key_hook_multi_two_fh(t_fs *fs)
{
	if (fs->p == 1)
	{
...
void	key_hook_multi_two_td(int keycode, t_fs *fs)
{
	if (keycode == 123)
		fs->multi.xmin += 0.10;
	if (keycode == 124)
...
void	key_hook_multi_two_sd(int keycode, t_fs *fs)
{
	if (keycode == 0)
		if (fs->multi.jf < 2)
			fs->multi.jf += 0.05;
...
int		key_hook_multi_two(int keycode, t_fs *fs)
{
	if (keycode >= 0 && keycode <= 53)
		key_hook_multi_two_sd(keycode, fs);
	if (keycode >= 67 && keycode <= 126)
		key_hook_multi_two_td(keycode, fs);
	if (fs->p == 1 || fs->p == 2)
		key_hook_multi_two_fh(fs);
	if (fs->p == 3)
	{
